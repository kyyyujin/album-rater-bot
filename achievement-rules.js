...
const PUBLIC_DESCRIPTIONS = require('./achievement-descriptions');
for (const definition of DEFINITIONS) {
  const description=PUBLIC_DESCRIPTIONS[definition.key];
  if(description&&!definition.metadata?.secret&&!definition.metadata?.discovery) definition.metadata={...definition.metadata,description};
}
